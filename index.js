...
function menuBoardPreloader() {
  Promise.all([
    ...
    getImage("./assets/images/menu-board/user-icon.jpg"),
...
soundCloseBtn.addEventListener("click", function () {
  ...
  setTimeout(() => {
    ...
    backgroundSound.src = "./assets/audio/Medium Track.mp3";
...
window.onload = function () {
  ...
  slider.oninput = function () {
    ...
    bubbleClickSound.volume = slider.value / 100;
    clockTickAudio.volume = slider.value / 100;
    coinDropAudio.volume = slider.value / 100;
    winningSound.volume = slider.value / 100;
    drawSound.volume = slider.value / 100;
    losingSound.volume = slider.value / 100;
    selectSound.volume = slider.value / 100;
  };
};
...
function check(x) {
  ...
  if (x == 1 || x == 2 || x == 3) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[0].firstChild.textContent * 4;
  ...
  if (x == 29 || x == 30 || x == 31) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[1].firstChild.textContent * 6;
    randomAnimal.style.display = "block";
  ...
  if (x == 25 || x == 26 || x == 27) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[2].firstChild.textContent * 12;
    randomAnimal.style.display = "block";
  ...
  if (x == 21 || x == 22 || x == 23) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[3].firstChild.textContent * 24;
    randomAnimal.style.display = "block";
  ...
  if (x == 5 || x == 6 || x == 7) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[4].firstChild.textContent * 4;
    randomAnimal.style.display = "block";
  ...
  if (x == 9 || x == 10 || x == 11) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[5].firstChild.textContent * 6;
    randomAnimal.style.display = "block";
  ...
  if (x == 13 || x == 14 || x == 15) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[6].firstChild.textContent * 12;
    randomAnimal.style.display = "block";
  ...
  if (x == 17 || x == 18 || x == 19) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[7].firstChild.textContent * 24;
    randomAnimal.style.display = "block";
  ...
  if (x == 0 || x == 8 || x == 16 || x == 24) {
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[8].firstChild.textContent * 24;
    randomAnimal.style.display = "block";
  ...
  if (
    ...
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[10].firstChild.textContent * 2;
  }
  if (
    x == 1 ||
    x == 2 ||
    ...
    myOwnCoin.firstChild.textContent =
      +myOwnCoin.firstChild.textContent +
      +myValue[11].firstChild.textContent * 2;
  }
